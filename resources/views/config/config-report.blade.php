...
<div class="card">
    ...
    <div class="card-body">
        <button class="btn btn-light">Mumbai</button>
        <button class="btn btn-light">Gurgaon</button>
        <div class="row mt-2">
        <div class="col-lg-4">
                <div class="card">
                    <div class="card-body bg-primary text-white ">
                        <div class="d-flex">
                            ...
                            <div class="text-right">
                                ...
                                <h2 class="card-text">{{ $totalDbLeads }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body bg-warning text-dark">
                        <div class="d-flex">
                            ...
                            <div class="text-right">
                                ...
                                <h2 class="card-text">{{ $totalConversion }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <table id="coursesTable" class="table table-hover" style="width:100%">
            ...
            <tbody>
                ...
                <tr data-details="{{ json_encode($course['details']) }}">
                    ...
                    <td>
                        <span class="badge bg-{{ $course['conversion'] > 5 ? 'success' : ($course['conversion'] > 3 ? 'warning' : 'danger text-light') }}">
                            {{ $course['conversion'] }}
                        </span>
                    </td>
                </tr>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                <td><strong class="text-primary">Facebook</strong></td>
                                                <td><strong class="text-primary">Google</strong></td>
                                                <td><strong class="text-primary">Google</strong></td>
                                                <td><strong class="text-primary">Facebook</strong></td>
                                                <td><strong class="text-primary">Google</strong></td>
                                                <td><strong class="text-primary">Google</strong></td>
